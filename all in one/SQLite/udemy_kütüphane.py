...
class Kitap:
    ...
    def __str__(self):
        return "Kitap İsmi: {}\nYazar: {}\nYayınevi: {}\nTür: {}\nBaskı: {}\n".format(
            self.isim, self.yazar, self.yayınevi, self.tür, self.baskı
        )
...
class Kütüphane:
    ...
    def baglanti_olustur(self):
        self.baglanti = sqlite3.connect("udemy_kütüphane.db")
    ...
    def kitap_ekle(self, kitap):
        ...
        self.cursor.execute(
            sorgu, (kitap.isim, kitap.yazar, kitap.yayınevi, kitap.tür, kitap.baskı)
        )
        self.baglanti.commit()
